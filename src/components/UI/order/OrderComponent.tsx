        ...
        <div className="border-4 rounded-3xl h-96">
            <div className="p-6">
                ...
                <div className="mt-20 flex flex-col space-y-2">
                    <Button color="blue-gray" className="rounded-3xl" onClick={toCartHandle}>добавить в корзину</Button>
                    <Button color="light-blue" className="rounded-3xl" onClick={buyNowHandle}>купить сейчас</Button>
                </div>
            </div>
        </div>
    );
